...
namespace BddDemo.Specifications.MSpec
{
    ...
    public class When_loading_the_foogle_search_page_4 : With_a_floogle_inventory
    {
    ...
    [Subject("Floogle Search")]
    public class When_searching_for_floogles_4 : With_a_floogle_inventory
    {
    ...
    [Subject("Floogle Search")]
    public class With_a_floogle_inventory_4
    {
